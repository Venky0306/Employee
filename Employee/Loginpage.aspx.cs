...
namespace Employee
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        {
            string query = "INSERT INTO otp_log (Otp id,Employee Id,Employee Number,otp,time_Stamp,status) VALUES (@id,@Customer_No,@User_Id,@OTP,@ctime_Stamp,@status) ";
